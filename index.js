...
bitcore.versionGuard = function(version) {
  if (version !== undefined) {
    var message = 'More than one instance of bitcore-lib-ltc-mini found. ' +
      'Please make sure to require bitcore-lib-ltc-mini and check that submodules do' +
      ' not also include their own bitcore-lib-ltc-mini dependency.';
